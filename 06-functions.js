...
// 매개변수의 이해
console.log("================ 매개변수")
// 매개변수 선언과 별도로 전달 된 모든 매개변수가 arguments 라는 함수 내장 매개변수로 전달

function getNumberTotal() { // 매개변수 정의 없음
    // console.log("전달 된 매개변수:", arguments);
    // 전달 받은 모든 매개변수를 합산해서 리턴
    let result = 0;
...
// - Number, String과 동등 한 지위를 갖는다
// - 변수에 할당 될 수 있고,
//       다른 함수의 매개변수로 전달 될 수 있다
// - 함수의 결과로 기턴 될 수 있다 -> 고계 함수
console.log("========= 콜백함수")
