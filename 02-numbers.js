...
console.log("============== Casting");
/* 자바 스크립트는 변수 선언시 데이터 타입을 지정하지 않고 중간에 데이터 타입이
변경 될 수 있으므로 데이터 형 변환이 필요 한 경우가 많다 */

// parseInt, parseFloat : Number 타입으로 변환하는 함수
console.log(parseFloat("011"), typeof parseInt("011"));
...
// 숫자로 변환 할 수 없는 형태의 문자열을 반환하면 -> NaN
let v = parseInt("a12345");
console.log(v, "->", typeof v);
// NaN가 포함 된 연산의 결과는 -> NaN
console.log(v, "* 3", v * 3);
// number 데이터가 NaN인지 확인 하려면 isNaN 함수
...
// Infinity와 수치형 데이터의 산술 연산 -> Infiniy
let result = 1 / 0 + 2024;
